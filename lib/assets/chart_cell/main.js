    ...
    template: `
      <div class="app">
        ...
        <div class="container">
          ...
          <div class="layers" v-for="(layer, index) in layers">
            <Accordion>
              <template v-slot:title>
                <span>
                  Charting: <span class="highlight">{{ layer.chart_type }}</span>
                  for <span class="highlight">{{ layer.data_variable }}</span>
                </span>
              </template>
              ...
              <div class="row">
                ...
                <div class="remove-layer">
                  <button v-if="hasLayers" class="button button--red button--sm" type="button"
          ...
          <div class="add-layer">
            <button class="button button--blue" type="button" @click="addLayer()">Add layer</button>
          </div>
        </div>
        </form>
      </div>
        ...
        template: `
          <div class="layer-wrapper" :class="{'wrapper--closed': !isOpen}">
            <button
              ...
              class="button button--gray accordion-control"
              :aria-expanded="isOpen"
              :aria-controls="id"
              type="button"
              :class="{'button--transparent': isOpen}"
            >
            ...
            <div v-show="isOpen" :id="id" :class="{'layer-content': isOpen}">
              <slot name="content" />
            </div>
          </div>
        `,
