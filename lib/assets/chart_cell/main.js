      ...
      <div class="app">
        ...
        <div class="container">
          ...
          <div class="layers">
            <Accordion v-for="(layer, index) in layers" @remove-layer="removeLayer(index)" :hasLayers="hasLayers">
              ...
              <template v-slot:content>
                <div class="row" v-if="layer.chart_type !== 'geodata'">
                  <BaseSelect
                    name="data_variable"
                    label="Data"
                    :layer="index"
                ...
                <div class="row" v-else">
                  <BaseSelect
                    ...
                    :options="geoDataOptions"
                    :required
                    :disabled="noDataVariable"
                  />
                  <BaseInput
                    name="geodata_feature"
                    label="Geodata Feature"
                    :layer="index"
          ...
          <div class="add-layer">
            ...
            <button class="button button--dashed" type="button" :disabled="unavailableDataVariable" @click="addGeoLayer()">
              <svg width="10" height="10" viewBox="0 0 10 10" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.41699 4.41602V0.916016H5.58366V4.41602H9.08366V5.58268H5.58366V9.08268H4.41699V5.58268H0.916992V4.41602H4.41699Z"/>
              </svg>
              Geodata
