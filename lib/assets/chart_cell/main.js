  ...
  const app = Vue.createApp({
    template: `
      <div class="app">
        ...
        <div class="container">
          ...
          <div class="layers">
            <Accordion v-for="(layer, index) in layers" @remove-layer="removeLayer(index)" :hasLayers="hasLayers" :isGeoLayer="(isGeoLayer(index))">
              ...
              <template v-slot:content>
                <div class="row" v-if="layer.chart_type !== 'geoshape'">
                  ...
                  <BaseSelect
                    ...
                    :options="layer.geodata ? geoDataOptions :chartOptions"
                    :required
                    :disabled="noDataVariable"
                  />
                  <BaseSwitch
                ...
                <div class="row" v-if="layer.chart_type !== 'geoshape'">
                  ...
                  <div class="input-icon-container" v-if="!layer.geodata">
                    <BaseSelect
                      name="color_field"
                      label="Color"
                      :layer="index"
    ...
    data() {
      return {
        ...
        geoDataOptions: ["point", "circle", "square"],
    ...
    computed: {
      ...
      hasLayers() {
        const onlyGeo =
          this.layers.length === 2 && this.layers[0].chart_type === "geoshape";
        return this.layers.length > 1 && !onlyGeo;
      },
      unavailableDataVariable() {
        return !this.dataVariables.includes(this.layers[0].data_variable);
      },
      hasGeoLayer() {
        const geoLayer = this.layers.find(
          (layer) => layer.chart_type === "geoshape"
        );
        return geoLayer ? true : false;
      },
    },
        ...
        template: `
          <div class="layer-wrapper" :class="{'wrapper--closed': !isOpen}">
            <div
              ...
              :aria-controls="id"
              v-show="hasLayers || (!isOpen && !hasLayers) || isGeoLayer"
            >
